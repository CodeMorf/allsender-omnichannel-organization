...
export interface DepartmentSettings {
  ...
  ai: { mode: 'disabled' | 'assistant' | 'first' | 'automatic'; agent_id?: string | null; chatbot_id?: string | null; response_language: string; similarity_threshold: number; prompt_override: string; fallback_message: string; human_handoff: boolean; human_handoff_message: string; handoff_reasons: string[] };
}
