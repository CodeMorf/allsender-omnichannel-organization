...
export interface DepartmentSettings {
  ...
  resolution: { mode: 'inherit' | 'custom' | 'disabled'; reason_requirement: 'none' | 'optional' | 'required'; auto_close: boolean; close_after_minutes: number; notify_before_minutes: number; notification_message: string; send_farewell: boolean; close_ai_chats: boolean };
